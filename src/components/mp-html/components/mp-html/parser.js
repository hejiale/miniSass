  ...
  if (close) {
    ...
    if (node.name === 'img') {
      if (attrs.src) {
        ...
        // let base64 = base64url_encode(shopInfo.storeNumber + "-" + uni.getStorageSync('juyouId'));
        // attrs.src = `${attrs.src}?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,size_30,text_${base64},color_ffffff,shadow_100,t_100,g_nw,x_4,y_4`;
        // 标记 webp
